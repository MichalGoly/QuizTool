...
\bibitem{2} Google Sign-In, "Google Identity homepage", 2018. [Online] Available: https://developers.google.com/identity/, [Accessed: Apr. 10, 2018].
  ...
  Google Single Sign On has been used to authenticate lecturers logging into the Quiz Tool.
...
\bibitem{3} Java Programming Language, "Java homepage", 2018. [Online] Available:
  ...
  Java would have been used if the Quiz Tool were to be developed for Android.

\bibitem{4} Android, "Android homepage", 2018. [Online] Available: https://www.android.com/, [Accessed: Apr. 11, 2018].

  Android is a mobile operating system developed by Google. The initial idea was to develop the Quiz Tool as a native, Android app.

\bibitem{5} iOS, "Apple homepage", 2018. [Online] Available: https://www.apple.com/uk/ios/ios-11/, [Accessed: Apr. 11, 2018].

  iOS is a mobile operating system created and developed by Apple Inc. The initial idea of developing Quiz Tool as a native
  Android app would prevent people owning iOS phones from using the tool.
...
\bibitem{6} React Native, "React Native homepage", 2018. [Online] Available: https://facebook.github.io/react-native/, [Accessed: Apr. 11, 2018].
  ...
  React Native lets you build mobile apps for both iOS and Android using only JavaScript. React Native has been
  considered as one of the alternatives to develop the tool.
...
\bibitem{7} JavaScript Programming Language, "JavaScript Mozilla docs", 2018. [Online]
  ...
  language of the web. MongoDB, Express.js, Angular and Node.js technologies used to develop the Quiz Tool are
  JavaScript based.

\bibitem{8} React, "React homepage", 2018. [Online] Available: https://reactjs.org/, [Accessed: Apr. 11, 2018].

  A JavaScript library for building user interfaces. It was one of the alternatives of developing the front
  end of the Quiz Tool.

\bibitem{9} Angular, "Angular homepage", 2018. [Online] Available: https://angular.io/, [Accessed: Apr. 11, 2018].

  Angular is a TypeScript-based front end development framework supported by Google. The front end of the Quiz Tool
  has been developed using Angular.
...
\bibitem{10} TypeScript Programming Language, "TypeScript homepage", 2018. [Online] Available: https://www.typescriptlang.org/, [Accessed: Apr. 11, 2018].
  ...
  TypeScript is a typed superset of JavaScript that compiles to plain JavaScript. TypeScript is used to write
  Angular applications, and the front end of the tool has been written using TypeScript.
...
\bibitem{11} I. Fette, A. Melnikov, "The WebSocket Protocol", [Online] Available: https://tools.ietf.org/html/rfc6455, [Accessed: Apr. 11, 2018].
  ...
  that has opted-in to communications from that code. Sockets are used to enable the Quiz Tool to serve lecture slides in real time to
  the audience.

\bibitem{12} Socket.io, "Socket.io homepage", 2018. [Online] Available: https://socket.io/, [Accessed: Apr. 11, 2018].

  Socket.io is a JavaScript library enabling bidirectional event-based communication. Socket.io is used to enable the Quiz Tool
  to serve lecture slides in real time to the audience.
...
\bibitem{13} Chat Application Tutorial, "Socket.io homepage", 2018. [Online] Available: https://socket.io/get-started/chat/, [Accessed: Apr. 11, 2018].
  ...
  A Socket.io tutorial guiding the student in developing a basic chat application using Socket.io, which was helpful during the early
  stages of Quiz Tool development.
...
\bibitem{14} Tour of Heroes Tutorial, "Angular homepage", 2018. [Online] Available: https://angular.io/tutorial, [Accessed: Apr. 11, 2018].
  ...
  The tutorial enabled me to learn Angular basics before developing the Quiz Tool.
...
\bibitem{15} Building Chat Application using MEAN Stack (Angular 4) and Socket.io, "djamware.com", 2018.
  ...
  Step by step tutorial of building a simple chat application using MEAN stack (Angular 4) and Socket.io, which was useful
  during the early stages of the development of the Quiz Tool.
...
\bibitem{17} Microsoft PowerPoint, "products.office.com", 2018. [Online] Available: https://products.office.com/en-gb/powerpoint, [Accessed: Apr. 11, 2018].
  ...
  A proprietary tool owned by Microsoft to create presentations. Qwizdom supports it, Quiz Tool does not.

\bibitem{18} MEAN stack, [Online] Available: https://github.com/linnovate/mean, [Accessed: Apr. 11, 2018].

    The MEAN stack uses Mongo, Express, Angular(4) and Node for simple and scalable fullstack js applications. The Quiz Tool
    has been written using the MEAN stack.

\bibitem{19} Docker, "Docker homepage", [Online] Available: https://www.docker.com/, [Accessed: Apr. 11, 2018].

    Docker allows apps to be containerised and run on multiple hosts in the same fashion. Quiz Tool has been containerised
    using Docker.

\bibitem{20} docker-compose, "docker-compose homepage", [Online] Available: https://docs.docker.com/compose/, [Accessed: Apr. 11, 2018].

    Compose is a tool for defining and running multi-container Docker applications, including the Quiz Tool.
...
\bibitem{21}  M. O\'Gara, "Ben Golub, Who Sold Gluster to Red Hat, Now Running dotCloud", 26th July 2013.
  ...
  A journal article mentioning what Docker does, which helped me to understand what Docker was.
...
\bibitem{23} Jenkins, "Jenkins homepage", [Online] Available: https://jenkins.io/, [Accessed: Apr. 11, 2018].
  ...
  competitors. It was considered as one of the continuous integration build agents for the Quiz Tool development.

\bibitem{24} Amazon Web Services, "AWS homepage", [Online] Available: https://aws.amazon.com/, [Accessed: Apr. 11, 2018].

  AWS provides cloud computing plaftoms to individuals, companies and governments. The production environment of the Quiz Tool is
  hosted on AWS.
...
\bibitem{26} Circle CI, "Circle CI  homepage", [Online] Available: https://circleci.com/, [Accessed: Apr. 12, 2018].
  ...
  repositories. Circle CI has been used to test and deploy the Quiz Tool to production.
...
\bibitem{27} Travis, "Travis homepage", [Online] Available: https://travis-ci.org/, [Accessed: Apr. 12, 2018].
  ...
  projects, hosted publicly on GitHub. It was therefore not appropriate for the Quiz Tool hosted in a private repository.
...
\bibitem{28} M. Shahin, M. Ali Babar, and L. Zhu, "Continuous Integration, Delivery and Deployment: A Systematic Review on
    ...
    This paper describes what continuos integration and delivery are, which was helpful during the Quiz Tool development.
...
\bibitem{31} Git Feature Branch Workflow, [Online] Available: https://www.atlassian.com/git/tutorials/comparing-workflows/feature-branch-workflow,
  [Accessed: Apr. 12, 2018].
    ...
    be merged to development/master. The workflow has been used during the tool development.
...
\bibitem{32} ZenHub, "ZenHub homepage", [Online] Available: https://www.zenhub.com/, [Accessed: Apr. 12, 2018].
    ...
    better manage work at hand. The kanban board has been used during the Quiz Tool development.
...
\bibitem{39} Amazon EC2, "EC2 homepage", [Online] Available: https://aws.amazon.com/ec2/, [Accessed: Apr. 13, 2018].
    ...
    cloud. It is designed to make web-scale cloud computing easier for developers. The Quiz Tool's production environment
    is hosted on an EC2 instance.
...
\bibitem{48} mongoose, "mongoose homepage", [Online] Available: http://mongoosejs.com/, [Accessed: Apr. 14, 2018].
    ...
    Mongoose provides a schema-based solution to model data in applications using MongoDB. It has been using in the Quiz Tool.
...
\bibitem{50} GridFS, "mongo docs", [Online] Available: https://docs.mongodb.com/manual/core/gridfs/, [Accessed: Apr. 15, 2018].
    ...
    A convention for storing large files in a MongoDB database. It was one of the alternatives of storing binary data in Quiz Tool's database.
...
\bibitem{51} ng2-file-upload, "ng2-file-upload homepage", [Online] Available: https://valor-software.com/ng2-file-upload/, [Accessed: Apr. 15, 2018].
    ...
    Library simplifying file upload from Angular applications. Quiz Tool's front end is written in Angular.
...
\bibitem{52} pdf-extract, "pdf-extract github repository", [Online] Available: https://github.com/nisaacson/pdf-extract, [Accessed: Apr. 15, 2018].
    ...
    Node PDF is a set of tools that takes in PDF files and converts them to usable formats for data processing, used by the Quiz Tool.
...
\bibitem{56} node-pdf2img, "node-pdf2img GitHub repository", [Online] Available: https://github.com/fitraditya/node-pdf2img, [Accessed: Apr. 15, 2018].
    ...
    A NodeJS module for converting pdf into image files in the Quiz Tool.
...
\bibitem{61} chai-http, "chai-http GitHub repository", [Online] Available: https://github.com/chaijs/chai-http, [Accessed: Apr. 17, 2018].
    ...
    applications. Used in Quiz Tool testing.
...
\bibitem{65} PhantomJS, "PhantomJS homepage", [Online] Available: http://phantomjs.org/, [Accessed: Apr. 18, 2018].
  ...
  PhantomJS headless web browser is spin up by Karma during front end unit tests of the tool.

\bibitem{66} Selenium, "Selenium homepage", [Online] Available: https://www.seleniumhq.org/, [Accessed: Apr. 18, 2018].

  Selenium is a tool which automates browsers. It has been used to drive browser interactions during integration/end-to-end tests of the tool.
...
\bibitem{67} Selenium-Grid, "Selenium homepage", [Online] Available: https://www.seleniumhq.org/docs/07\_selenium\_grid.jsp, [Accessed: Apr. 18, 2018].
  ...
  Selenium-Grid can be used to run selenium tests on multiple web browers in parallel. Used during Quiz Tool integration testing.
...
\bibitem{68} Getting Started with Docker Compose, "docker-selenium GutHub repository", [Online] Available: https://github.com/SeleniumHQ/docker-selenium/wiki/Getting-Started-with-Docker-Compose, [Accessed: Apr. 18, 2018].
  ...
  A step-by-step introduction to using the official Selenium Docker images using a basic hub/node configuration and docker-compose. The tutorial
  has been used to understand how to use the selenium grid with Docker during Quiz Tool integration testing.
