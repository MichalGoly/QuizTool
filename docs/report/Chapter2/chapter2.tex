...
or not. An edit panel visible below has been added, to allow lecturers specify
...
slide can become a quiz. If slide was not eligible to become a quizz, the radio button
...
This was enough to make a slide eligible to be marked as a single choice quiz and rendered as one,
...
side shows a bar chart cabaple of displaying students' answers as they come in. Lecturer can
...
clients. They would be able to select one of the options and submit their answer
only once. The "A", "B", "C", "D", "E" buttons are generated automatically based
