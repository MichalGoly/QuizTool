...
participation was voluntry, and their anonymous answers would be used to
generate a session report using the tool report generation functionality.
The two hour lecture ended with a voluntry user evaluation, where students
were asked to provide their feedback on their experiece of using the tool,
