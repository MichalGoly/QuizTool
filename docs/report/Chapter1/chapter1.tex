...
This approach would still require the front end for the lecturer to be developed in a web development
framework, and a natural choice would be to use React\cite{8} to keep the learning curve as low
as possible.
